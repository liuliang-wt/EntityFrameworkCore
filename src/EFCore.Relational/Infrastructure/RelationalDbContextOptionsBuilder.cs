...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
        ...
        where TExtension : RelationalOptionsExtension, new()
    {
        ...
        ///     </para>
        ///     <para>
        ///         Note that only a single <see cref="IDbCommandInterceptor" /> can be registered. To use more than one,
        ///         combine them into a composite class that implements <see cref="IDbCommandInterceptor" />.
        ///     </para>
        /// </summary>
