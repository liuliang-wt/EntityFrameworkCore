        ...
        IForeignKeyOwnershipChangedConvention
    {
            ...
            IConventionContext<string> context)
        {
            if ((targetEntityTypeBuilder.Metadata.Builder != null
                ...
                && !Process(sourceEntityTypeBuilder.Metadata, memberInfo, context))
            {
                context.StopProcessing();
            }
        }

        private bool Process(IConventionEntityType entityType, MemberInfo navigationProperty, IConventionContext context)
        {
            DiscoverRelationships(entityType.Builder, context);
            ...
            {
                Process(derivedEntityType, navigationProperty, context);
            }
