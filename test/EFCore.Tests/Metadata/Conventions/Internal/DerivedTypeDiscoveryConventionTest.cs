...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions.Internal
{
    public class DerivedTypeDiscoveryConventionTest
    {
        ...
        public void Discovers_child_types()
        {
            ...
            new DerivedTypeDiscoveryConvention(new TestLogger<DbLoggerCategory.Model, TestLoggingDefinitions>()).ProcessEntityTypeAdded(entityBuilderA, TODO);
            ...
            new DerivedTypeDiscoveryConvention(new TestLogger<DbLoggerCategory.Model, TestLoggingDefinitions>()).ProcessEntityTypeAdded(entityBuilderB, TODO);
